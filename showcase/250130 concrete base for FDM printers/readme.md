Started from reading the [article by CNC Kitchen](https://www.cnckitchen.com/blog/reduce-your-3d-printing-noise-with-a-concrete-paver) then found that some farmer actually did it:
