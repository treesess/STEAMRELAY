**Case cause:** A temperature and humidity chamber has a data hole for sensor cores, while we needed to use a USB hub to connect to the sensors inside the chamber. 
